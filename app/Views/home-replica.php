...
<body>
    ...
    <div id="parchment" class="page-body">
                ...
                <div class="row mt-4">
                    <div class="col-12 col-lg-4 col-md-4">
                        <div class="video_wrapper">
                            <iframe width="100%" height="315" src="https://www.youtube.com/embed/SL0DcHCbL9Q"
                    ...
                    <div class="col-12 col-lg-4 col-md-4">
                        <div class="video_wrapper">
                            <iframe width="100%" height="315" src="https://www.youtube.com/embed/vs-_E_dTtp0"
                                title="YouTube video player" frameborder="0"
                                allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"
                                allowfullscreen></iframe>
                        </div>
                    ...
                    <div class="col-12 col-lg-4 col-md-4">
                        <div class="video_wrapper">
                            <iframe width="100%" height="315" src="https://www.youtube.com/embed/2vxYUs8JVnM"
                                title="YouTube video player" frameborder="0"
                                allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"
                                allowfullscreen></iframe>
                        </div>
        ...
        <!-- About -->
        <div class="background_dark_image"
            style="background-image: url('/client_assets/images/background/bg_blank.jpg')">
                    ...
                    <div class="tab-pane fade show active" id="pills-biography" role="tabpanel"
                        ...
                        <div class="row mt-4">
                            <div class="col-12 col-lg-6">
                                ...
                                <br />
                                <a href="/about" class="know_more_btn mt-4" target="_blank"
        ...
        <div class="background_dark_image" style="background-image: url('/client_assets/images/background/pic_9.jpg')">
            <div class="container">
                ...
                <div class="row">
                    <div class="col-12 col-lg-4 col-md-4">
                        <div class="video_wrapper">
                            <iframe width="100%" height="315" src="https://www.youtube.com/embed/BHdkxbUB3OI"
                                title="YouTube video player" frameborder="0"
                                allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"
                                allowfullscreen></iframe>
                        </div>
                    ...
                    <div class="col-12 col-lg-4 col-md-4">
                        <div class="video_wrapper">
                            <iframe width="100%" height="315" src="https://www.youtube.com/embed/ksQk4qzE1SA"
                                title="YouTube video player" frameborder="0"
                                allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"
                                allowfullscreen></iframe>
                        </div>
                    ...
                    <div class="col-12 col-lg-4 col-md-4">
                        <div class="video_wrapper">
                            <iframe width="100%" height="315" src="https://www.youtube.com/embed/IvYaZWqsfag"
                                title="YouTube video player" frameborder="0"
                                allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"
                                allowfullscreen></iframe>
                        </div>
                    ...
                    <div class="col-12 col-lg-4 col-md-4">
                        <div class="video_wrapper">
                            <iframe width="100%" height="315" src="https://www.youtube.com/embed/7bmXS9Z_71A"
                                title="YouTube video player" frameborder="0"
                                allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"
                                allowfullscreen></iframe>
                        </div>
                    ...
                    <div class="col-12 col-lg-4 col-md-4">
                        <div class="video_wrapper">
                            <iframe width="100%" height="315" src="https://www.youtube.com/embed/cYodwyADDeg"
                                title="YouTube video player" frameborder="0"
                                allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"
                                allowfullscreen></iframe>
                        </div>
                    ...
                    <div class="col-12 col-lg-4 col-md-4">
                        <div class="video_wrapper">
                            <iframe width="100%" height="315" src="https://www.youtube.com/embed/5tskOtLqaQI"
                                title="YouTube video player" frameborder="0"
                                allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"
                                allowfullscreen></iframe>
                        </div>
                    ...
                    <div class="col-12 col-lg-4 col-md-4">
                        <div class="video_wrapper">
                            <iframe width="100%" height="315" src="https://www.youtube.com/embed/UvZwl0VNew8"
                                title="YouTube video player" frameborder="0"
                                allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"
                                allowfullscreen></iframe>
                        </div>
                    ...
                    <div class="col-12 col-lg-4 col-md-4">
                        <div class="video_wrapper">
                            <iframe width="100%" height="315" src="https://www.youtube.com/embed/CuhclJlWiCg"
                                title="YouTube video player" frameborder="0"
                                allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"
                                allowfullscreen></iframe>
                        </div>
                    ...
                    <div class="col-12 col-lg-4 col-md-4">
                        <div class="video_wrapper">
                            <iframe width="100%" height="315" src="https://www.youtube.com/embed/skZeb_rLCrI"
                                title="YouTube video player" frameborder="0"
                                allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"
                                allowfullscreen></iframe>
                        </div>
                ...
                <div class="row">
                    <div class="col-12 col-lg-4 col-md-4 mx-auto">
                        <div class="collaboration">
                            ...
                            <a href="https://youtu.be/OF008lXPKCk" class="n_play_btn" target="_blank"
                                rel="noopener noreferrer"><i class="uil uil-play"></i></a>
                        </div>
                    </div>
                    <div class="col-12 col-lg-4 col-md-4 mx-auto">
                        <div class="collaboration">
                            <img src="/client_assets/images/thumbnails/b5RA1JrSJwY.jpg" class="image" alt="" />
                            <a href="https://youtu.be/b5RA1JrSJwY" class="n_play_btn" target="_blank"
                                rel="noopener noreferrer"><i class="uil uil-play"></i></a>
                        </div>
                    </div>
                    <div class="col-12 col-lg-4 col-md-4 mx-auto">
                        <div class="collaboration">
                            ...
                            <a href="https://youtu.be/MwYWcKb3UJw" class="n_play_btn" target="_blank"
                                rel="noopener noreferrer"><i class="uil uil-play"></i></a>
                        </div>
                    </div>
                    <div class="col-12 col-lg-4 col-md-4 mx-auto">
                        <div class="collaboration">
                            ...
                            <a href="https://youtu.be/k3b_lXFns1s" class="n_play_btn" target="_blank"
                                rel="noopener noreferrer"><i class="uil uil-play"></i></a>
                        </div>
                    </div>
                    <div class="col-12 col-lg-4 col-md-4 mx-auto">
                        <div class="collaboration">
                            ...
                            <a href="https://youtu.be/ZcjW3-fGUko" class="n_play_btn" target="_blank"
                                rel="noopener noreferrer"><i class="uil uil-play"></i></a>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-12 col-lg-4 col-md-4">
                        <div class="collaboration">
                            ...
                            <a href="https://youtu.be/W9Us__ppiHQ" class="n_play_btn" target="_blank"
                                rel="noopener noreferrer"><i class="uil uil-play"></i></a>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-12 col-lg-4 col-md-4">
                        <div class="collaboration">
                            ...
                            <a href="https://youtu.be/SURBIBiEyAE" class="n_play_btn" target="_blank"
                                rel="noopener noreferrer"><i class="uil uil-play"></i></a>
                        </div>
                    </div>
                    <div class="col-12 col-lg-4 col-md-4">
                        <div class="collaboration">
                            ...
                            <a href="https://youtu.be/gPD7a45BhNs" class="n_play_btn" target="_blank"
                                rel="noopener noreferrer"><i class="uil uil-play"></i></a>
                        </div>
                    </div>
                    ...
                    <div class="col-12 col-lg-4 col-md-4">
                        <div class="collaboration">
                            ...
                            <a href="https://youtu.be/fYcZOkQ1-nw" class="n_play_btn" target="_blank"
                                rel="noopener noreferrer"><i class="uil uil-play"></i></a>
                        </div>
                    </div>
                    <div class="col-12 col-lg-4 col-md-4">
                        <div class="collaboration">
                            ...
                            <a href="https://youtu.be/EQMiks2S7gY" class="n_play_btn" target="_blank"
                                rel="noopener noreferrer"><i class="uil uil-play"></i></a>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-12 col-lg-4 col-md-4">
                        <div class="collaboration">
                            ...
                            <a href="https://youtu.be/2ybb3CKDSxs" class="n_play_btn" target="_blank"
                                rel="noopener noreferrer"><i class="uil uil-play"></i></a>
                        </div>
                    </div>
                    <div class="col-12 col-lg-4 col-md-4">
                        <div class="collaboration">
                            ...
                            <a href="https://youtu.be/X5isMK80lLg" class="n_play_btn" target="_blank"
                                rel="noopener noreferrer"><i class="uil uil-play"></i></a>
                        </div>
                    </div>
                    <div class="col-12 col-lg-4 col-md-4">
                        <div class="collaboration">
                            ...
                            <a href="https://youtu.be/W6RAX47pQZw" class="n_play_btn" target="_blank"
                                rel="noopener noreferrer"><i class="uil uil-play"></i></a>
                        </div>
                    </div>
                    <div class="col-12 col-lg-4 col-md-4">
                        <div class="collaboration">
                            ...
                            <a href="https://youtu.be/8lNKIy6pLDw" class="n_play_btn" target="_blank"
                                rel="noopener noreferrer"><i class="uil uil-play"></i></a>
                        </div>
                    </div>
                    <div class="col-12 col-lg-4 col-md-4">
                        <div class="collaboration">
                            ...
                            <a href="https://youtu.be/NelRKV3Dt7g" class="n_play_btn" target="_blank"
                                rel="noopener noreferrer"><i class="uil uil-play"></i></a>
                        </div>
                    </div>
                    <div class="col-12 col-lg-4 col-md-4">
                        <div class="collaboration">
                            ...
                            <a href="https://youtu.be/76Ifwnu1rl0" class="n_play_btn" target="_blank"
                                rel="noopener noreferrer"><i class="uil uil-play"></i></a>
                        </div>
                    </div>
                    <div class="col-12 col-lg-4 col-md-4">
                        <div class="collaboration">
                            ...
                            <a href="https://youtu.be/tmDIDBw7QdY" class="n_play_btn" target="_blank"
                                rel="noopener noreferrer"><i class="uil uil-play"></i></a>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-12 col-lg-4 col-md-4">
                        <div class="collaboration">
                            ...
                            <a href="https://youtu.be/wJvYSI7dqNQ" class="n_play_btn" target="_blank"
                                rel="noopener noreferrer"><i class="uil uil-play"></i></a>
                        </div>
                    </div>
                    <div class="col-12 col-lg-4 col-md-4">
                        <div class="collaboration">
                            ...
                            <a href="https://youtu.be/nXac1Kq3YGQ" class="n_play_btn" target="_blank"
                                rel="noopener noreferrer"><i class="uil uil-play"></i></a>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-12 col-lg-4 col-md-4">
                        <div class="collaboration">
                            ...
                            <a href="https://youtu.be/Ucelgw3koko" class="n_play_btn" target="_blank"
                                rel="noopener noreferrer"><i class="uil uil-play"></i></a>
                        </div>
                    </div>
                    <div class="col-12 col-lg-4 col-md-4">
                        <div class="collaboration">
                            ...
                            <a href="https://youtu.be/3U-_UVwh-uQ" class="n_play_btn" target="_blank"
                                rel="noopener noreferrer"><i class="uil uil-play"></i></a>
                        </div>
                    </div>
                    <div class="col-12 col-lg-4 col-md-4">
                        <div class="collaboration">
                            ...
                            <a href="https://youtu.be/OKGyJHkQLww" class="n_play_btn" target="_blank"
                                rel="noopener noreferrer"><i class="uil uil-play"></i></a>
                        </div>
                    </div>
                </div>
        ...
        <!-- social -->
        <div class="background_dark_image"
            style="background-image: url('/client_assets/images/background/black_circle_bg.jpg')">
